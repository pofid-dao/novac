(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  [14, 4],
  {
    ...
    '5rEg': function(e, t, n) {
      ...
      function z(e, t) {
        return !t || ('object' !== k(t) && 'function' !== typeof t) ? V(e) : t;
      }
      function V(e) {
        if (void 0 === e)
          throw new ReferenceError(
            ...
            return (
              ...
              (o.resizeTextarea = function() {
                ...
                if (e && o.textArea) {
                  ...
                  o.setState(
                    { textareaStyles: r, resizeStatus: Ve },
                    function() {
    ...
    TeRw: function(e, t, n) {
      ...
      ['success', 'info', 'warning', 'error'].forEach(function(e) {
        V[e] = function(t) {
          return V.open(C(C({}, t), { type: e }));
        };
      }),
        (V.warn = V.warning),
        (V.useNotification = S(I, z));
      t['a'] = V;
    },
    Uc92: function(e, t, n) {
      'use strict';
      ...
      class I extends m['Component'] {
        constructor() {
          super(...arguments),
            ...
            (this.onSetAuctionPrice = e => {
              var t = this;
              t.setState({ visibleAuctionPrice: !1, loading: !0 });
              var n = t.state.contractIndex;
              h['a']
                .setAuctionPrice(n, e['password'])
                .then(e => {
                  M('success', 'SUCCESS', e),
                    t.setState({ loading: !1, visibleAuctionPrice: !1 });
                })
                .catch(e => {
                  t.setState({ loading: !1 });
                  var n = 'string' === typeof e ? e : e.message;
        ...
        borrow(e, t, n) {
          ...
          h['a'].getMinBackedAmount(e).then(a => {
            r.setState({
              ...
              mintCoin: t,
              proxy: n,
              minBorrowValue: v['a'].toValue(new C.a(a).toString(10), o),
            }),
              r.setVisible(!0);
          });
        }
          ...
          if (t && t.total > 0) {
            for (
              var w = function(r) {
                  var o = [],
                    a = t.data[r],
                    i = new C.a(a.backedValue)
                      .multipliedBy(new C.a(y))
                      .dividedBy(new C.a(d))
                      .dividedBy(new C.a(a.mintValue))
                      .multipliedBy(100)
                      .toFixed(2);
                  1 == a.status
                    ? a.owns &&
            ...
            var _ = b.a.createElement(
              ...
              b.a.createElement(
                ...
                b.a.createElement(
                  ...
                  e.currentRateNumerator,
                  ' ',
                  e.backeCoin,
                  ' =',
                  ' ',
                  e.currentRateDenominator,
                  ' ',
                  h,
                ),
                b.a.createElement(
        ...
        render() {
          var e = this,
            ...
            f = n.fee,
            p = n.visibleAuction,
            d = n.visibleAuctionPrice,
            m = n.mintValue,
            v = n.subPanes,
            h = n.panes,
            g = n.minBorrowValue,
            w = { mintCoin: s, mintValue: m },
            S = Object.keys(h),
            C = [];
          if (S.length > 0) {
            var j,
            ...
            b.a.createElement(
              ...
              b.a.createElement(
                ...
                b.a.createElement(
                  a['a'],
                  { span: 12 },
                  b.a.createElement('span', null, 'SSC List'),
                ),
              ...
              b.a.createElement('p', null),
              b.a.createElement(y['a'], { type: 'card', animated: !0 }, C),
              b.a.createElement('p', null),
            ),
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        ...
                        t.abrupt(
                          'return',
                          e.callMethod('getTradingPairs', n.MainPKr, ['en']),
                        )
                      );
                    case 2:
                    case 'end':
                          ...
                          new Promise((o, a) => {
                            ...
                            m['a']
                              ...
                              .then(n => {
                                (b['gas'] = n),
                                  l.a.executeContract(b, function(r) {
                                    y['a'].addTx(c, u, r, t, n, v.address, e),
                                      o(r);
                                  });
                              })
                              .catch(e => {
    ...
    iMMW: function(e, t, n) {
      ...
      o['a']
        ...
        .init({
          ...
          fallbackLng: a['a'].get(a['a'].keys.language)
            ? a['a'].get(a['a'].keys.language)
            : 'en_US',
          debug: !1,
      ...
      var r = n('kLXV'),
        ...
        p = e => {
          ...
          return l.a.createElement(
            ...
            {
              visible: t,
              title: f['a'].t('button_borrow'),
              okText: f['a'].t('button_ok'),
              cancelText: f['a'].t('button_cancel'),
              onCancel: s,
              onOk: () => {
                w.validateFields()
                  .then(e => {
            ...
            l.a.createElement(
              ...
              l.a.createElement(
                c['a'].Item,
                {
                  name: 'amountes',
                  label: ''
                    .concat(f['a'].t('form_lable_amount'), '(')
                    .concat(d, ')'),
                  rules: [
                    { required: !0, message: f['a'].t('form_input_amount') },
                  ],
                  className: 'collection-create-form_last-form-item',
                },
                l.a.createElement(i['a'], {
                  min: v['minBorrowValue'],
                  defaultValue: 1,
                  step: 1,
                  style: { width: '200px' },
                  onChange: e => {
                    b(w.getFieldValue('amountes'));
                  },
                  precision: 0,
                }),
              ),
              l.a.createElement(
                ...
                {
                  name: 'password',
                  label: f['a'].t('form_lable_password'),
                  rules: [
                    { required: !0, message: f['a'].t('form_input_password') },
                  ],
                  className: 'collection-create-form_last-form-item',
                },
              ...
              l.a.createElement(
                ...
                l.a.createElement(
                  ...
                  {
                    label: ''
                      .concat(f['a'].t('form_lable_estimate'), '(')
                      .concat(p, ')'),
                  },
                  y,
                ),
    ...
    wCAj: function(e, t, n) {
      ...
      function R(e, t) {
        ...
        if (d) a = d;
          ...
          if (((a = z), p)) {
            var V = p(z, s, l);
            T(V) ? ((a = V.children), (o = V.props)) : (a = V);
          }
        }
        'object' !== N(a) ||
          Array.isArray(a) ||
      ...
      function Mt(e) {
        ...
        Ze && (K = { overflowY: 'scroll', maxHeight: d.y }),
          Je &&
            ((B = { overflowX: 'scroll' }),
            Ze || (K = { overflowY: 'hidden' }),
          ...
          It = r['createElement'](
            ...
            r['createElement'](
              Tt,
              {
                pingLeft: De,
                pingRight: Ke,
                props: bt({}, e, { stickyOffsets: Xe, mergedExpandedKeys: he }),
              },
              b &&
                r['createElement'](
                  st,
        ...
        var Dt = r['useMemo'](
          ...
          zt = r['useMemo'](
            ...
            [Ee, xt, a, ie, _e, Ze, $e, Je, se, fe, re, ee, ge, ae, ue],
          ),
          Vt = r['useMemo'](
            function() {
        ...
        return r['createElement'](
          ...
          r['createElement'](
            ye.Provider,
            { value: zt },
            r['createElement'](ke.Provider, { value: Vt }, It),
          ),
        );
      }
      (Mt.Column = b),
        ...
        var y = function() {
          ...
          b = function() {
            for (var e = arguments.length, r = new Array(e), o = 0; o < e; o++)
              r[o] = arguments[o];
            var a = r[1];
            f(Vt(Vt({}, p), { current: 1, pageSize: a })),
              n(1, a),
              t && t.onShowSizeChange && t.onShowSizeChange.apply(t, r);
          };
        return !1 === t
          ? [{}, function() {}]
          : [Vt(Vt({}, p), { onChange: m, onShowSizeChange: b }), y];
      }
      function Xt(e, t, n) {
        var o = r['useRef']({});
        function a(r) {
            ...
            return (
              ...
              (e.renderCheckbox = function(t) {
                ...
                var O = i()(
                    f,
                    ((n = {}),
                    Vn(n, ''.concat(g, '-wrapper'), !0),
                    Vn(n, ''.concat(g, '-rtl'), 'rtl' === a),
                    Vn(n, ''.concat(g, '-wrapper-checked'), w.checked),
                    Vn(n, ''.concat(g, '-wrapper-disabled'), w.disabled),
                    n),
                  ),
                  _ = i()(Vn({}, ''.concat(g, '-indeterminate'), d));
                return r['createElement'](
                  'label',
      ...
      (Zn.__ANT_CHECKBOX = !0),
        (Zn.defaultProps = { indeterminate: !1 }),
        (Zn.contextType = Rn);
      var Jn = Zn;
      Jn.Group = In;
      var $n = Jn,
      ...
      function ei(e) {
        ...
        var je = r['useMemo'](
          ...
          Me = function(e, t, n) {
            ...
            return (
              ...
              i()(Ua({}, ''.concat(q, '-row-selected'), Te.has(Z(e, t))), r)
            );
          };
        ...
        if (!1 !== p) {
          ...
          if (null !== Ce.position && Array.isArray(Ce.position)) {
            ...
            Be || Ke
              ? (Be && (Re = Ve(Be.toLowerCase().replace('top', ''))),
                Ke && (Ae = Ve(Ke.toLowerCase().replace('bottom', ''))))
              : (Ae = Ve());
          } else Ae = Ve();
        }
        'boolean' === typeof O
