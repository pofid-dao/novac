    ...
    '5MNL': function(e, t, a) {
                    ...
                    case 2:
                      return (
                        ...
                        t.abrupt(
                          'return',
                          new m.a(
                            new m.a(s).dividedBy(1e18).toFixed(0, 1),
                          ).toNumber(),
                        )
                      );
                    case 5:
      ...
      var f = new g(),
        ...
        v = e => {
          var t = e.data;
          function a(e, t, a) {
            var s = Object(h['measureTextWidth'])(t, a),
              _ = s.width,
              i = s.height,
              n = e / 2,
              o = 1;
            e < _ &&
              (o = Math.min(
                Math.sqrt(
                  Math.abs(
                    Math.pow(n, 2) / (Math.pow(_ / 2, 2) + Math.pow(i, 2)),
                  ),
                ),
                1,
              ));
            var r = 'width:'.concat(e, 'px;');
            return '<div style="'
              .concat(r, ';font-size:')
              .concat(o, 'em;line-height:')
              .concat(o < 1 ? 1 : 'inherit', ';">')
              .concat(t, '</div>');
          }
          t ||
            (t = [
              { type: y['a'].t('posNotMinted'), value: 0 },
              { type: y['a'].t('burned'), value: 0 },
              { type: y['a'].t('circulating'), value: 0 },
            ]);
          var s = {
            appendPadding: 10,
            data: t,
            ...
            radius: 1,
            innerRadius: 0.64,
            meta: { value: { formatter: e => ''.concat(e, ' PFID') } },
            label: {
              type: 'inter',
              offset: '-50%',
              ...
              title: {
                ...
                customHtml: (e, t, s) => {
                  var _ = e.getBoundingClientRect(),
                    i = _.width,
                    n = _.height,
                    o = Math.sqrt(Math.pow(i / 2, 2) + Math.pow(n / 2, 2)),
                    r = s ? s.type : y['a'].t('total');
                  return a(o, r, { fontSize: 24 });
                },
              },
              content: {
                offsetY: 4,
                ...
                customHtml: (e, t, s, _) => {
                  var i = e.getBoundingClientRect(),
                    ...
                    o = s
                      ? ''.concat(s.value)
                      : ''.concat(
                          _.reduce((e, t) => e + t.value, 0),
                          ' PFID',
                        );
                  return a(n, o, { fontSize: 20 });
                },
              },
            },
            interactions: [
          ...
          return u.a.createElement(b['a'], s);
        };
        ...
        render() {
          ...
          return u.a.createElement(
            ...
            u.a.createElement(
              'div',
              null,
              u.a.createElement('h1', null, y['a'].t('menus_pfid_info')),
              u.a.createElement(n['a'], { dashed: !0 }),
              u.a.createElement(
                s['a'],
                null,
                u.a.createElement(
            ...
            u.a.createElement(n['a'], { dashed: !0 }),
            u.a.createElement('div', null, u.a.createElement(v, { data: o })),
          );
        }
      }
      t['default'] = P;
      ...
      class n {
        ...
        post(e, t) {
          var a = i['a'].get(i['a'].keys.walletInfo),
            s = a && a.rpc ? a.rpc : this.host,
            n = { id: this.messageId++, jsonrpc: '2.0', method: e, params: t };
