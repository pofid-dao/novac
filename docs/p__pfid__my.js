      ...
      function It(e) {
        ...
        return r['createElement'](
          ...
          r['createElement'](
            ye.Provider,
            { value: zt },
            r['createElement'](ke.Provider, { value: Kt }, Mt),
          ),
        );
      }
      (It.Column = b),
      ...
      function ei(e) {
        ...
        if (!1 !== p) {
          ...
          if (null !== Ce.position && Array.isArray(Ce.position)) {
            ...
            Be || Ve
              ? (Be && (Re = Ke(Be.toLowerCase().replace('top', ''))),
                Ve && (Ae = Ke(Ve.toLowerCase().replace('bottom', ''))))
              : (Ae = Ke());
          } else Ae = Ke();
        }
        'boolean' === typeof O
