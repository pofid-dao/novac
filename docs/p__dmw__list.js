  ...
  [9],
  {
      ...
      class u {
        ...
        addTx(e, t, a, n, i, s, o) {
          if (a.indexOf('0x') > -1 && 66 === a.length) {
            var c = this;
            r['a'].getDecimal(t).then(u => {
              var l = {
                assets: [
                  {
                    amount: r['a'].toValue(e.toString(10), u).toString(10),
                    currency: t,
                  },
                ],
                tx_hash: a,
    ...
    AY6W: function(e, t, a) {
      ...
      class o {
        ...
        post(e, t) {
          var a = s['a'].get(s['a'].keys.walletInfo),
            ...
            d.a.createElement(
              ...
              d.a.createElement(
                g['a'].Item,
                {
                  name: 'account',
                  label: 'Kind of',
                  rules: [{ required: !1, message: 'Please select a kind!' }],
                ...
                d.a.createElement(
                  ...
                  d.a.createElement(
                    h,
                    { value: '1' },
                    'Adjust liquidation ratio',
                  ),
                  d.a.createElement(h, { value: '2' }, 'Adjust VM'),
                  d.a.createElement(h, { value: '3' }, 'Close this DMW'),
                ),
              ),
              d.a.createElement(
                g['a'].Item,
                {
                  ...
                  rules: [
                    { required: !0, message: 'Please input description!' },
                  ],
                  className: 'collection-create-form_last-form-item',
                },
                d.a.createElement(w, null),
              ),
              d.a.createElement('p', null, 'Pledge\uff1a1000 PFID'),
            ),
          );
        },
        S = v,
            ...
            d.a.createElement(
              ...
              d.a.createElement(
                ...
                d.a.createElement(
                  b['a'],
                  { defaultValue: '1' },
                  d.a.createElement(C, { value: '1' }, 'Dollar($)'),
                  d.a.createElement(C, { value: '2' }, 'Euro($)'),
                ),
              ),
              d.a.createElement(
                g['a'].Item,
      ...
      class q extends _['Component'] {
        constructor() {
          super(...arguments),
            ...
            (this.onCreateSSC = e => {
              this.setState({ visibleSSC: !1 });
            }),
            (this.setVisibleSSC = e => {
              this.setState({ visibleSSC: e });
            });
        }
        componentDidMount() {
          var e = this;
          e.list()
            ...
            .catch(t => {
              ...
              p['a'].error(a), e.setState({ loading: !1 });
            });
        }
        list() {
          var e = this;
          return Object(l['a'])(
            i.a.mark(function t() {
              var a, n, l, p, m, _, y, g, f, b, h, w, v, S;
                            ...
                            _.forEach(e => {
                              ...
                              f.push(
                                d.a.createElement(
                                  ...
                                  d.a.createElement(
                                    ...
                                    d.a.createElement(
                                      ...
                                      d.a.createElement(
                                        'p',
                                        null,
                                        M['a'].t('pages_dmw_liquidationRatio'),
                                        ':',
                                        ' ',
                                        d.a.createElement(
                                          'strong',
                                  ...
                                  d.a.createElement(s['a'], { dashed: !0 }),
                                  d.a.createElement(
                                    'p',
                                    null,
                                    d.a.createElement(
                                      'h2',
                                      null,
                                      M['a'].t('pages_dmw_stableCoin'),
                                      ' ',
                                      a,
                                      ' DMW',
                                    ),
                                  ),
                                  d.a.createElement('p', null, i),
                                ),
                              );
                          },
                            h.s();
          ...
          return d.a.createElement(
            ...
            d.a.createElement(
              ...
              d.a.createElement(
                r['a'],
                { span: 12 },
                d.a.createElement('span', null, M['a'].t('pages_dmw_list')),
              ),
              d.a.createElement(r['a'], {
                span: 12,
            ...
            d.a.createElement(m['a'], { type: 'card', animated: !0 }, n),
            d.a.createElement(S, {
              visible: t,
        ...
        return (
          ...
          (e.prototype.some = function(e, t) {
            ...
            return new Promise(function(e, s) {
              var o = [],
                r = i.request().index(a);
              r.openCursor(n, 'prev').onsuccess = function(a) {
                var n = a.target.result;
                n
                  ? (o.push(n.value), o.length < t ? n.continue() : e(o))
                  : e(o);
              };
            });
          }),
        ...
        i = (function() {
          ...
          return (
              ...
              n.onupgradeneeded = function(t) {
                ...
                e.forEach(function(e) {
                  ...
                  if (!t.includes(e.name)) {
                    var i = n.createObjectStore(e.name, {
                      keyPath: e.keyPath,
            ...
            (e.prototype.connect = function() {
              var e = this;
              return new Promise(function(t, a) {
                var n = indexedDB.open(e.name, e.version);
                (n.onsuccess = function(e) {
                  t(e.target.result);
                }),
                  (n.onerror = function(e) {
            ...
            (e.prototype.insert = function(e, t) {
              ...
              return new Promise(function(i, s) {
                a.connect().then(function(a) {
                  var o = new n.Table(e, a);
                  o.insert(t)
                    .then(i)
                    .catch(s);
                });
            ...
            (e.prototype.some = function(e, t, a) {
              var i = this;
              return new Promise(function(s, o) {
                i.connect().then(function(i) {
                  var r = new n.Table(e, i);
                  r.some(t, a)
                    .then(function(e) {
                      s(e);
                    })
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        ...
                        t.abrupt(
                          'return',
                          e.callMethod('getTradingPairs', a.MainPKr, ['en']),
                        )
                      );
                    case 2:
                    case 'end':
                  ...
                  switch ((n.prev = n.next)) {
                    case 0:
                      return (
                        ...
                        n.abrupt(
                          'return',
                          a.callMethod('getProxyAddress', s.MainPKr, [e, t]),
                        )
                      );
                    case 2:
                    case 'end':
                          ...
                          new Promise((t, a) => {
                            y['a']
                              ...
                              .then(n => {
                                if ('0x' !== n)
                                  try {
                                    var i = r.callContract.unPackData(e, n);
                                    t(i);
                                  } catch (s) {
                                    a(s.message);
                                  }
                              ...
                              .then(a => {
                                (g['gas'] = a),
                                  l.a.executeContract(g, function(n) {
                                    d['a'].addTx(r, c, n, t, a, f.address, e),
                                      i(n);
                                  });
                              })
                              .catch(e => {
    ...
    iMMW: function(e, t, a) {
      ...
      i['a']
        ...
        .init({
          ...
          fallbackLng: s['a'].get(s['a'].keys.language)
            ? s['a'].get(s['a'].keys.language)
            : 'en_US',
          debug: !1,
              ...
              return i.a.wrap(function(t) {
                while (1)
                  switch ((t.prev = t.next)) {
                    ...
                    case 7:
                      return (t.next = 9), u['a'].post('sero_getDecimal', [e]);
                    case 9:
                      return (
                        (n = t.sent),
                        (s = new r.a(n, 16).toNumber()),
                        c['a'].set(c['a'].keys.decimal(e), s),
                        t.abrupt('return', new Promise(e => e(s)))
                      );
                    case 13:
                    case 'end':
                      return t.stop();
