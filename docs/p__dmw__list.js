      ...
      class c {
        ...
        addTx(e, t, a, n, i, s, o) {
          if (a.indexOf('0x') > -1 && 66 === a.length) {
            var u = this;
            r['a'].getDecimal(t).then(c => {
              var l = {
                assets: [
                  {
                    amount: r['a'].toValue(e.toString(10), c).toString(10),
                    currency: t,
                  },
                ],
                tx_hash: a,
    ...
    HpiR: function(e, t, a) {
            ...
            d.a.createElement(
              ...
              d.a.createElement(
                ...
                d.a.createElement(
                  ...
                  d.a.createElement(w, { value: '2' }, 'Adjust VM'),
                  d.a.createElement(w, { value: '3' }, 'Close this DMW'),
                ),
              ),
              d.a.createElement(
                g['a'].Item,
            ...
            d.a.createElement(
              ...
              d.a.createElement(
                ...
                d.a.createElement(
                  b['a'],
                  { defaultValue: '1' },
                  d.a.createElement(x, { value: '1' }, 'Dollar($)'),
                  d.a.createElement(x, { value: '2' }, 'Euro($)'),
                ),
              ),
              d.a.createElement(
                g['a'].Item,
      ...
      class q extends _['Component'] {
        ...
        list() {
          ...
          return Object(l['a'])(
            i.a.mark(function t() {
              var a, n, l, p, m, _, y, g, f, b, w, h, v, S;
                            ...
                            try {
                              for (y.s(); !(m = y.n()).done; ) {
                                ...
                                try {
                                  for (x.s(); !(g = x.n()).done; ) {
                                    var C = g.value;
                                    _.indexOf(C.name) > -1 || _.push(C.name);
                                  }
                                } catch (k) {
                                  x.e(k);
                                } finally {
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        ...
                        t.abrupt(
                          'return',
                          e.callMethod('getTradingPairs', a.MainPKr, ['']),
                        )
                      );
                    case 2:
                    case 'end':
                ...
                while (1)
                  switch ((i.prev = i.next)) {
                    case 0:
                      return (
                        (r = n),
                        (u = r.callContract.packData(e, a)),
                        (c = { from: t, to: o['a'].dmwBase.address, data: u }),
                        i.abrupt(
                          'return',
                          new Promise((t, a) => {
                            y['a']
                              ...
                              .then(a => {
                                (g['gas'] = a),
                                  l.a.executeContract(g, function(n) {
                                    d['a'].addTx(r, u, n, t, a, f.address, e),
                                      i(n);
                                  });
                              })
                              .catch(e => {
              ...
              return i.a.wrap(function(t) {
                while (1)
                  switch ((t.prev = t.next)) {
                    ...
                    case 2:
                      if (((a = u['a'].get(u['a'].keys.decimal(e))), !a)) {
                        t.next = 7;
                        break;
                      }
                      return t.abrupt('return', new Promise(e => e(a)));
                    case 7:
                      return (t.next = 9), c['a'].post('sero_getDecimal', [e]);
                    case 9:
                      return (
                        (n = t.sent),
                        (s = new r.a(n, 16).toNumber()),
                        u['a'].set(u['a'].keys.decimal(e), s),
