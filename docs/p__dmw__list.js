                              ...
                              .then(a => {
                                (y['gas'] = a),
                                  p.a.executeContract(y, function(n) {
                                    d['a'].addTx(o, c, n, t, a, b.address, e),
                                      s(n);
                                  });
                              })
                              .catch(e => {
    ...
    f0qC: function(e, t, a) {
      ...
      class B extends y['Component'] {
        ...
        list() {
          ...
          return Object(m['a'])(
            i.a.mark(function t() {
              var a, n, s, m, _, d, g, y, b, f, w, v, k, S;
                            ...
                            try {
                              for (y.s(); !(d = y.n()).done; ) {
                                ...
                                try {
                                  for (E.s(); !(w = E.n()).done; ) {
                                    var P = w.value;
                                    g.indexOf(P.name) > -1 || g.push(P.name);
                                  }
                                } catch (D) {
                                  E.e(D);
                                } finally {
