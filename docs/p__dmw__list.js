  ...
  [9],
  {
    ...
    '63fq': function(e, t, a) {
      ...
      var p = {
        ...
        l = { databaseName: 'novac', tables: [p], version: 1 },
        m = new u();
      t['a'] = m;
    },
    AY6W: function(e, t, a) {
    ...
    HpiR: function(e, t, a) {
      ...
      var n = a('W9HT'),
        ...
        y = a('q1tI'),
        f = a.n(y),
        b = (a('XTta'), a('2qtc'), a('kLXV')),
        h = (a('y8nQ'), a('Vl3Y')),
        w = (a('5NDa'), a('5rEg')),
        v = (a('OaEy'), a('2fM7')),
        x = a('iMMW'),
        S = a('SQwP'),
        k = (v['a'].Option, w['a'].TextArea),
        C = e => {
          var t = e.visible,
            a = e.onCreate,
            n = e.onCancel,
          ...
          return f.a.createElement(
            ...
            f.a.createElement(
              ...
              f.a.createElement(
                ...
                f.a.createElement(w['a'], { type: 'password' }),
              ),
            ),
          );
        },
      ...
      class O extends y['Component'] {
        ...
        list() {
          ...
          return Object(m['a'])(
            i.a.mark(function t() {
              var a, n, s, m, _, d, g, y, b, h, w, v, S, k;
                            ...
                            g.forEach(e => {
                              ...
                              b.push(
                                f.a.createElement(
                                  ...
                                  f.a.createElement(o['a'], { dashed: !0 }),
                                  f.a.createElement(
                                    'p',
                                    null,
                                    f.a.createElement(
            ...
            f.a.createElement(
              ...
              f.a.createElement(
                ...
                f.a.createElement(
                  c['a'],
                  { span: 12 },
                  f.a.createElement('span', null, x['a'].t('pages_dmw_list')),
                ),
              ...
              f.a.createElement(g['a'], { type: 'card', animated: !0 }, s),
              f.a.createElement(P, {
                visible: t,
          ...
          return (
              ...
              n.onupgradeneeded = function(t) {
                ...
                e.forEach(function(e) {
                  ...
                  if (!t.includes(e.name)) {
                    var s = n.createObjectStore(e.name, {
                      keyPath: e.keyPath,
            ...
            (e.prototype.some = function(e, t, a) {
              ...
              return new Promise(function(i, o) {
                s.connect().then(function(s) {
                  var r = new n.Table(e, s);
                  r.some(t, a)
                    .then(function(e) {
                      i(e);
                    })
                      ...
                      return (
                        ...
                        s.abrupt(
                          ...
                          new Promise((s, i) => {
                            ...
                            g['a']
                              .post('sero_estimateGas', [f])
                              .then(a => {
                                (y['gas'] = a),
                                  p.a.executeContract(y, function(n) {
                                    d['a'].addTx(r, c, n, t, a, b.address, e),
                                      s(n);
                                  });
                              })
                              .catch(e => {
      ...
      function s(e, t, n) {
        if (n) {
          ...
          if (2 === a.embedType) {
            ...
            o &&
              (console.log('popupModel send msg >>>> ', i),
              o.contentWindow.postMessage(i, '*'));
          } else parent.postMessage(i, '*');
          a.callbackHandler.set(s, n);
        }
      }
      (a.Rpc = ''),
