                  ...
                  switch ((o.prev = o.next)) {
                    case 0:
                      return (
                        ...
                        { from: t, to: i['a'].auction.address, data: c },
                        o.abrupt(
                          'return',
                          new Promise((e, t) => {
                            e();
        ...
        return r['createElement'](
          'div',
          {
            className: a()(
              ...
              y,
              ((t = {}),
              g(t, ''.concat(S, '-').concat(v), v && 'default' !== v),
              g(t, ''.concat(S, '-bordered'), !!f),
      ...
      var r = n('NUBc'),
        ...
        C = e => {
          var t = e.visible,
            ...
            p = new S.a(o['totalCut']).toFixed(4);
    ...
    wCAj: function(e, t, n) {
      ...
      function A(e, t) {
        ...
        var Z = E({ title: X }, U, {}, A, {
          ...
          className: i()(
            ...
            c,
            ((n = {}),
            P(n, ''.concat(T, '-fix-left'), Y),
            P(n, ''.concat(T, '-fix-left-first'), w),
            P(n, ''.concat(T, '-fix-left-last'), x),
            P(n, ''.concat(T, '-fix-right'), Q),
            P(n, ''.concat(T, '-fix-right-first'), O),
            P(n, ''.concat(T, '-fix-right-last'), S),
            P(n, ''.concat(T, '-ellipsis'), R),
            P(n, ''.concat(T, '-with-append'), C),
            n),
            A.className,
            W,
          ),
          style: E({}, A.style, {}, J, {}, G, {}, B),
          ref: I(y) ? t : null,
        });
        ...
        var o = t && 'object' === qt(t) ? t : {},
          ...
          c = Object(r['useState'])(function() {
            return {
              ...
              pageSize: 'defaultPageSize' in u ? u.defaultPageSize : Gt,
            };
          }),
          l = Ft(c, 2),
          s = l[0],
          ...
          K = r['useCallback'](
            function(t) {
              ...
              if ('row' === x && t.length && !C) {
                ...
                return (
                  L && (R.fixed = L),
                  [R, Br(Br({}, M), { fixed: L })].concat(Gr(K))
                );
              }
              return [Br(Br({}, M), { fixed: y || no(t[0]) })].concat(Gr(t));
            },
      ...
      function ei(e) {
        var t,
          ...
          U = W('table', n),
          q = W('dropdown', s),
          H = Za({ childrenColumnName: v, expandIconColumnIndex: C }, O),
        ...
        var ve = r['useMemo'](
          ...
          Oe = Qt(he.length, f, xe),
          Se = Ha(Oe, 2),
          Ce = Se[0],
          Ee = Se[1];
        (te.pagination = !1 === f ? {} : Yt(f, Ce)), (te.resetPagination = Ee);
        var Pe = r['useMemo'](
            function() {
              if (!1 === f || !Ce.pageSize) return he;
              var e = Ce.current,
                t = void 0 === e ? 1 : e,
                n = Ce.total,
                r = Ce.pageSize,
            ...
            [!!f, he, Ce && Ce.current, Ce && Ce.pageSize, Ce && Ce.total],
          ),
          je = oo(d, {
            prefixCls: U,
            data: he,
